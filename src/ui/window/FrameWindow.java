 ...
 * 
 * @author cylong
 * @version May 25, 2014 12:25:26 AM
 */
public class FrameWindow extends JFrame {
	...
	public class ExtendFrame extends Thread {
		...
		public void run () {
			while (true) {
				...
				FrameWindow.this.setSize(width, height);
				FrameWindow.this.setLocationRelativeTo(null);
				if (width == maxWidth) {
					break;
				}
			}
	...
	public class PanelCreatHome extends JPanel implements Runnable, MouseListener, MouseMotionListener {

		/** serialVersionUID */
		public static final long serialVersionUID = 1L;
		public DialogCreateHome frameCreateHome = null;
		/**
		 * 关闭图片的左上角坐标
		 */
		public int exitX = 0;
		...
		public PanelCreatHome (DialogCreateHome frameCreateHome) {
